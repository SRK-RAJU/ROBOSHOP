...
resource "null_resource" "ansible" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "ansible-pull -U https://dev.azure.com/SUDDALARAJUKUMAR/ROBOSHOP/_git/roboshop?path=/ansible roboshop-pull.yml -e COMPONENT=${element(var.components, count.index)} -e ENV=dev"
    ]
  }
}
